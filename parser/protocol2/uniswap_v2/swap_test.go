...
func TestSwapEvent_TokensOrdered_Buy(t *testing.T) {
	// https://etherscan.io/tx/0x15a1e1638edf8d2154df3a2bbed898e99451861a172bb968ff765b02a7c5f00d#eventlog#31
	ethLogGetter, pairService := protocol2.PrepareTest()
	receiptLog := ethLogGetter.GetEthLog("0x15a1e1638edf8d2154df3a2bbed898e99451861a172bb968ff765b02a7c5f00d", 5)
	...
	expectAmt0, _ := decimal.NewFromString("46492.194800278")
	expectAmt1, _ := decimal.NewFromString("0.247139463427129002")
	expectTx := &orm.Tx{
		TxHash:        "0x15a1e1638edf8d2154df3a2bbed898e99451861a172bb968ff765b02a7c5f00d",
		Event:         "buy",
